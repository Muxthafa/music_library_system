    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid" >
        ...
        <ol class="breadcrumb" style="background-color:#787878">
          ...
          <li class="breadcrumb-item active"style="color:black">Artists</li>
        </ol>
            ...
            <div class="card text-white bg-dark o-hidden h-100 card-columns-fluid">
              <div class="card-body">
                ...
                <div class="card-body mr-5" style="color:#00ff40">
                        ...
                        <?php
                        $var_value=$elements["artist_name"];
                        ?>
                        <a href="artist2.php?varname=<?php echo $var_value ?>"style="color:#00ff40" role="button"  class="card-text"><b><?php

                         echo $elements["artist_name"]; ?></b></p>
