...
<body id="page-top" style="background-image: url('home.jpg');">
  ...
  <div id="wrapper">
    ...
    $result = mysqli_query($con,"select * from track t,genre g,genre_belong b where t.track_id=b.track_id and b.genre_id=g.genre_id and g.genre_name like '$str_var'  ");
