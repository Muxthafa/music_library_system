    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid" >
        ...
        <ol class="breadcrumb" style="background-color:#787878">
          ...
          <li class="breadcrumb-item active"style="color:black">Desi Hits</li>
        </ol>
                   
 <?php
    include('db.php');
    $result =mysqli_query($con,"select DISTINCT lang from track where lang like 'hindi' or lang like 'kannada'");
?>
        <!-- Icon Cards-->
        <div class="row-fluid">
            ...
            <div class="card text-white bg-dark o-hidden h-100 card-columns-fluid">
              <div class="card-body">
                ...
                <div class="card-body mr-5" style="color:#00ff40">
                  <?php
                        $var_value=$elements["lang"];
                        ?>
                        
                        <a href="desi2.php?varname=<?php echo $var_value ?>"style="color:#00ff40" role="button"  class="card-text"><b><?php echo $elements["lang"]; ?></b></a>
