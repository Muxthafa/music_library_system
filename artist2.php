    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid" >
        ...
        <ol class="breadcrumb" style="background-color:#787878">
          ...
          <li class="breadcrumb-item active"style="color:black">Songs</li>
        </ol>
    
    <?php
     include('db.php');
    $str_var = $_GET['varname'];
    $result = mysqli_query($con,"select * from track t,artist a,composed_by b where t.track_id=b.track_id and b.artist_id=a.artist_id and a.artist_name like '$str_var'  ");
